...
- Use each TC-specific command for normal headless execution. Launch visible UI only with `npm.cmd run test:headed`, which runs TC-001 through TC-006 sequentially and performs their real side effects.
